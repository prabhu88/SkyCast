    ...
    return(
        <> 
            <div className="d-flex flex-row mb-5">
                ...
                <button class="btn btn-xs" style={{fontSize:"inherit",background:'orange'}} onClick={reqData}> Submit</button>
            </div>                       
            ...
            {weather.data && (
                ...
                <Card style={{width:'300px'}}>                                        
                    <Card.Header flex>                        
                        <Card.Title>
                            <img src={weather.data.current.condition.icon} alt="" /> Temp :  
                ...
                <Card style={{width:'300px'}}>                                        
                    <Card.Header flex>                        
                        <Card.Title>
                            <img src={weather.data.current.condition.icon} alt="" /> Wind :  
